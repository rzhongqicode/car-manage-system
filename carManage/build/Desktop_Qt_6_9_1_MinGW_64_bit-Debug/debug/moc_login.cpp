...
template <> constexpr inline auto login::qt_create_metaobjectdata<qt_meta_tag_ZN5loginE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "login",
        "on_button_user_clicked",
        "",
        "on_button_admin_clicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'on_button_user_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_button_admin_clicked'
...
void login::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_button_user_clicked(); break;
        case 1: _t->on_button_admin_clicked(); break;
        default: ;
        }
    }
    (void)_a;
